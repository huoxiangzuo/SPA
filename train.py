...
from SPAnet import spa_tiny_224 as create_model   # SPANet_tiny, SPANet_small. SPANet_base
from utils import read_split_data, create_lr_scheduler, get_params_groups, train_one_epoch, evaluate, \
                  read_train_data, read_val_data
...
def main(args):
    ...
    for epoch in range(start_epoch + 1, args.epochs + 1):
        ...
        if epoch % 50 == 0:
            ...
            torch.save(model.state_dict(), './model_weight/checkpoint/ckpt_best_%s.pth' % (str(epoch)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', type=str, default="data/kvasirv2/train")
    parser.add_argument('--val_data_path', type=str, default="data/kvasirv2/val")
